...
class InstaCartSpider(SpiderLoginInterface):
    ...
    async def extract_data(self):
        ...
        store_url = soup.find(name="div", attrs={"data-identifier": "store_logo"})
        self.item = {
            "storeName": store_url.img.attrs['alt'],
            "storeUrl": store_url.img.attrs['src'],
            "products": self.get_all_products(self.first_store)
        }

    def get_all_products(self, store_id):
        pass
